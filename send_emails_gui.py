...
first_column = [
    ...
    [   sg.Text(" Α. ΑΡΧΙΚΕΣ ΛΕΙΤΟΥΡΓΙΕΣ",font=("Arial",16)), sg.Text("(Προαιρετικά, πριν την αποστολή - χωρίς αποστολή)",font=("Arial",11))],
    [    
        sg.Button('Δημιουργία υποφακέλων (με βάση τη στήλη FOLDER-NAME του .xls που θα δηλώσετε πιο κάτω), για αρχεία που θα θέλατε να επισυναφθούν στο e-mail',size=(65, 2),key='make_folders',font=("Arial",11),button_color='dark slate gray')
    ],
    [    
    ...
    [
        sg.Text("                "),
        sg.In(size=(50, 3), font=("Arial",12),enable_events=True,key="mail_from",default_text='ac@athenscollege.edu.gr'),
    ],
    [   sg.Text("        ")],
    [
        sg.Text("    To/CC/BCC (από αντίστοιχες στήλες του .xls): ",font=("Arial",14))
    ],
    [
        sg.Text("                "),
        sg.In(size=(50, 1), font=("Arial",12), enable_events=True,key="recipient_list_dir",default_text='./01list/list.xls'),
        sg.FileBrowse()
    ],
    [   sg.Text("             ")],
    [
    ...
    [   sg.Text("                  ή/και")],
    [   sg.Text("                    επισύναψη σελίδων/αρχείων από το διαχωρισμένο .pdf:",font=("Arial",11)),
    ...
    [
        sg.Text("                        "),
        sg.In(size=(44, 1), font=("Arial",12), enable_events=True,key="pdf_directory",default_text='./04pdf/Sourcefile.pdf'),
        sg.FileBrowse()
    ],
    [   sg.Text("             ")],
    [   sg.Text("             ")],
